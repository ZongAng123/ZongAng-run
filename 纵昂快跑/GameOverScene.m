...
- (instancetype)initWithSize:(CGSize)size time:(float)time num:(int)num
{
    if (self = [super initWithSize:size]) {
        ...
        SKLabelNode *label = [SKLabelNode labelNodeWithText:@"啊！纵昂掉下去了！"];
        label.fontSize = 37;
        ...
        SKLabelNode *timeLabel = [SKLabelNode labelNodeWithText:[NSString stringWithFormat:@"不可思议！你家纵昂竟然坚持了%0.1f秒",[TimeManager shareInstance].timeCount]];
